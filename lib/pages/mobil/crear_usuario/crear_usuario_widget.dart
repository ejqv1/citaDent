...
class CrearUsuarioWidget extends StatefulWidget {
  const CrearUsuarioWidget({Key? key}) : super(key: key);
...
class _CrearUsuarioWidgetState extends State<CrearUsuarioWidget> {
  ...
  void initState() {
    ...
    _model.passwordVerifiqueController ??= TextEditingController();
  }
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 0.0, 0.0, 16.0),
                            child: TextFormField(
                              controller: _model.passwordVerifiqueController,
                              obscureText: !_model.passwordVerifiqueVisibility,
                              decoration: InputDecoration(
                                labelText: 'confirma el password',
                                hintStyle:
                                    FlutterFlowTheme.of(context).bodyLarge,
                                enabledBorder: OutlineInputBorder(
                                  borderSide: BorderSide(
                                ...
                                suffixIcon: InkWell(
                                  onTap: () => setState(
                                    () => _model.passwordVerifiqueVisibility =
                                        !_model.passwordVerifiqueVisibility,
                                  ),
                                  focusNode: FocusNode(skipTraversal: true),
                                  child: Icon(
                              ...
                              style: FlutterFlowTheme.of(context).bodyLarge,
                              validator: _model
                                  .passwordVerifiqueControllerValidator
                                  .asValidator(context),
                            ),
                          ),
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                if (_model.passwordController.text !=
                                    _model.passwordVerifiqueController.text) {
