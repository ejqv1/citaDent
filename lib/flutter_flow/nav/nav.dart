...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'confirmarCita',
          path: '/confirmarCita',
          builder: (context, params) => ConfirmarCitaWidget(
            idCitas: params.getParam(
                'idCitas', ParamType.DocumentReference, false, ['citas']),
          ),
        ),
        FFRoute(
          name: 'Home',
        ...
        FFRoute(
          name: 'ubicacion',
          path: '/ubicacion',
          builder: (context, params) => UbicacionWidget(),
        ),
        FFRoute(
          name: 'addDate',
          path: '/addDate',
          builder: (context, params) => AddDateWidget(),
        ),
        FFRoute(
          name: 'citasTerminadas',
          path: '/citasTerminadas',
          builder: (context, params) => CitasTerminadasWidget(),
        ),
        FFRoute(
          name: 'historial',
          path: '/historial',
        ...
        FFRoute(
          name: 'homeWeb',
          path: '/homeWeb',
          builder: (context, params) => HomeWebWidget(),
        )
